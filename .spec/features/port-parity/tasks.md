...
## T-028 — Expandir CIDR no port scan [pendente]
...
## T-029 — Banner grabbing e detecção de versão [pendente]
...
## T-030 — SYN scan com raw socket [pendente]
...
## T-031 — Ping sweep / descoberta de host [pendente]
- Refs: US-024, AC-054
...
## T-032 — Fingerprint de SO embutido [pendente]
- Refs: US-025, AC-055
...
## T-033 — Timing e retries configuráveis [pendente]
- Refs: US-026, AC-056
- Arquivos: internal/recon/portscan.go, cmd/port.go
- Esforço: medio
...
## T-036 — Framework de scripts Go (NSE-lite) [pendente]
...
## T-037 — Saída XML compatível com nmap -oX [pendente]
- Refs: US-030, AC-061
