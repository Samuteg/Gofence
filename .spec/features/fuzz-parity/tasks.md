...
## T-038 — Detecção de wildcard/catch-all no fuzzer [concluida]
- Refs: US-020, AC-047
...
## T-041 — Recursão em diretórios [concluida]
- Refs: US-032, AC-064
...
## T-046 — Auth, cookie e User-Agent via CLI [concluida]
- Refs: US-037, AC-069
- Arquivos: cmd/fuzz.go, internal/surface/fuzzer.go, internal/surface/fuzzer_features.go
- Esforço: medio
- Notas: flags --auth user:pass (Basic), --cookie "k=v", --user-agent "…"; aplicadas em toda requisição do fuzzer via SetAuth